      ...
      <div className="relative z-10 grid grid-cols-12 h-full container mx-auto px-4">
        ...
        <div className="col-start-3 col-span-6 flex flex-col justify-center">
          <h1 className="space-y-6">
            <span className="block text-3xl md:text-5xl lg:text-6xl font-serif text-pink-50 font-bold leading-tight font-crafty-girls">
          ...
          <p className="text-lg md:text-xl text-pink-100 font-serif italic leading-relaxed max-w-2xl font-geist-sans">
