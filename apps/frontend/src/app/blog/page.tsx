...
export const metadata: Metadata = {
  ...
  description:
    "A collection of stories, poems, and thoughts from Dipisha Kalura's writing journey. Read personal essays, poetry, and creative writing.",
  openGraph: {
    title: "Blog | From My Journal - Dipisha Books",
    description:
      "A collection of stories, poems, and thoughts from Dipisha Kalura's writing journey.",
    type: "website",
  },
};
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            A collection of stories, poems, and thoughts from my writing
            journey.
          </p>
